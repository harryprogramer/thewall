package thewall.game.tengine.models.loader.renderer;
...
public class VAOGLRenderer extends ImmediateModeOGLRenderer {
    ...
    private void flushBuffer() {
        ...
        GL11.glVertexPointer(0, 3,0,vertices);
        GL11.glColorPointer(0, 4,0,colors);
        GL11.glTexCoordPointer(0, 2,0,textures);
